...
<body class="no-scroll" id="pro-detial-body">
    ...
    <div class="product-container">
        ...
        <div class="product-img">
    	    <img alt="<%=p.getCategory() %>" src="images/<%=p.getImage()%>">
        </div>
        <div class="product-img"> 
    	    <h1><%=p.getDescription() %></h1>
    	    <h5>Category: <%=p.getCategory() %></h5>
    	    <h2><span><%=percent%>%   </span>₹<%=disprice %></h2>
		    <p>M.R.P= <span><%=p.getPrice() %></span></p></a>
            <p><strong>Earn Points:</strong> <%=p.getPoints() %></p>
